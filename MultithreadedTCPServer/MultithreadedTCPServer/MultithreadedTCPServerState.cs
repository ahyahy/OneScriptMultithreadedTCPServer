...
namespace mtcps
{
    [ContextClass("МсСостояниеСервера", "MsServerState")]
    public class MsMultithreadedTCPServerState : AutoContext<MsMultithreadedTCPServerState>, ICollectionContext, IEnumerable<IValue>
    {
        ...
        public MsMultithreadedTCPServerState()
        {
