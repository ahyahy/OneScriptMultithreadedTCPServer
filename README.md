...
### Текущее состояние
Есть возможность создавать самоподписанный сертификат методами библиотеки.  
Скомпилированная **dll** и **самоподписанные сертификаты** для тестирования лежат в подкаталоге tests. Возможно будет необходимо правой кнопкой мыши вызвать свойства распакованных файлов и **разблокировать** их. Релиз скоро выпущу.
