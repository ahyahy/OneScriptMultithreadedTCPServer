...
+ По данной работе на сайте Инфостарт размешена публикация [Многопоточный TCP сервер с защищённым каналом для сценарного языка OneScript](https://infostart.ru/1c/articles/2575211/).
