...
Скомпилированная dll и самоподписанные сертификаты лежат в подкаталоге tests. Возможно будет необходимо правой кнопкой мыши вызвать свойства распакованных файлов и разблокировать их. Релиз скоро выпущу.
